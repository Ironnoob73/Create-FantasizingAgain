...
public class ShadowPlatingRecipe extends StandardProcessingRecipe<SingleRecipeInput> implements IAssemblyRecipe {

    public ShadowPlatingRecipe(ProcessingRecipeParams params) {
        super(CFARecipeTypes.SHADOW_PLATING, params);
    }
    ...
    public Component getDescriptionForAssembly() {
        return CreateLang.translateDirect("recipe.assembly.shadow_platting");
    }

    @Override
    public void addRequiredMachines(Set<ItemLike> list) {
        list.add(CFABlocks.SHADOW_STEEL_TUNNEL.get());
    }
