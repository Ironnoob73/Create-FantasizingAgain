...
public class SturdyCrateScreen extends AbstractCrateScreen<SturdyCrateMenu> {
    ...
    public void renderForeground(@NotNull GuiGraphics ms, int mouseX, int mouseY, float partialTicks) {
        ...
        if (menu.isFold && menu.contentHolder.isDoubleCrate())
            ms.drawString(font, Component.translatable("create_fantasizing.gui.crate.page", menu.page + 1), x + 32 + (menu.contentHolder.isMountedProxy() ? 0 : 18), y + 126 + capacityLabelOffset, 0x4B3A22, false);
