...
public abstract class AbstractDoubleStorageScreen<T extends AbstractDoubleStorageMenu> extends AbstractSimiContainerScreen<T> {
    ...
    public void containerTick() {
        ...
        if (!storageHolder.isMountedProxy() // THIS CONDITION IS GENERATED BY DEEPSEEK V4
                && minecraft != null && minecraft.level != null
                && !blockEntry.has(minecraft.level.getBlockState(storageHolder.getBlockPos())))
    ...
    void sendPacketToServer(){
        if (storageHolder.isMountedProxy()) // THIS STATEMENT IS GENERATED BY DEEPSEEK V4
            // But actually, it seems these two lines of code are unnecessary...
            return; // No config packets on contraptions
