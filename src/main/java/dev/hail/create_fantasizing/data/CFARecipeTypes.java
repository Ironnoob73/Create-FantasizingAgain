...
public enum CFARecipeTypes implements IRecipeTypeInfo, StringRepresentable {
    ...
    public static final Codec<CFARecipeTypes> CODEC = StringRepresentable.fromEnum(CFARecipeTypes::values);
    ...
    CFARecipeTypes(StandardProcessingRecipe.Factory<?> processingFactory) {
        this(() -> new StandardProcessingRecipe.Serializer<>(processingFactory));
        isProcessingRecipe = true;
    }

    CFARecipeTypes(ProcessingRecipe.Factory<ItemApplicationRecipeParams, ? extends ItemApplicationRecipe> itemApplicationFactory) {
