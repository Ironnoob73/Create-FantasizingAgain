...
public class ExposingCategory extends CreateRecipeCategory<ExposingRecipe> {
    ...
    @Override
    protected void setRecipe(IRecipeLayoutBuilder builder, ExposingRecipe recipe, IFocusGroup focuses) {
        builder
    ...
    @Override
    protected void draw(ExposingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics gui, double mouseX, double mouseY) {
